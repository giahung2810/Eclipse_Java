...
<body>
    <div class="col-5 offset-4 mt-4">
        <form name="form" action="SearchServlet" method='post'>
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-check">
                        ...
                        <input type="radio" class="form-check-input" name="check" id="check" value="IDNV" checked> IDNV
                      </label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                        <input type="radio" class="form-check-input" name="check" id="check" value="IDPB" checked> IDPB
                      </label>
                    </div>
